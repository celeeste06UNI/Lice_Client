...
public class RuleController {
	...
	public ModelAndView saveRule(ModelAndView model, HttpServletRequest request) {
		...
		return new ModelAndView("redirect:/main/newRule");
	...
	public ModelAndView updateRule(ModelAndView model,@ModelAttribute("id_rule") int id_rule, @ModelAttribute("operator") String operator,
